...
class ReconcileByDateRequest extends PaginatedByDateRequest {
	...
	/**
	* the 'interval' argument is not part of the Hypercharge XML API.
	* 'interval' may be usefull for the usecases 'give me the transactions for day xy' or '... for one week from date xy'.
	* 'interval' is a valid DateInterval (see http://php.net/manual/en/class.dateinterval.php) string or DateInterval allowed.
	* if interval given: end_date will be calculated with start_date + interval. If you specify end_date and interval, given end_date will be ignored.
	* e.g. for the range 2013-06-12 00:00:00 until 2013-06-12 23:59:59
	* $request = new Hypercharge\ReconcileByDateRequest(array('start_date'=>'2013-06-12', 'interval'=>'P1D');
	* or
	* $request = new Hypercharge\ReconcileByDateRequest(array('start_date'=>'2013-06-12', 'interval'=>new DateInterval('P1D'));
