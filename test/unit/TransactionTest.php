	...
	*/
	...
	function testShouldNotRedirect() {
		$syncResponseFixtures = array(
			...
			,'init_recurring_gtd_sepa_debit_sale.xml'
			,'init_recurring_gtd_sepa_debit_authorize.xml'
			,'init_recurring_sale.xml'
			,'pay_in_advance.xml'
			,'payment_on_delivery.xml'
			,'purchase_on_account.xml'
			,'gtd_purchase_on_account.xml'
			,'recurring_debit_sale.xml'
			,'recurring_sepa_debit_sale.xml'
			,'recurring_gtd_sepa_debit_sale.xml'
